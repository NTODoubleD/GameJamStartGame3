...
half gamma = 0.454545;
					...
					sampledLightMap = SampleLightmap(i.shadowCoord.xy, normalDirection) * (mainLight.shadowAttenuation + 0.4);
#else
					sampledLightMap = SampleLightmap(i.shadowCoord.xy, normalDirection);
#endif
...
lightColor = half4(1,1,1,1);
					...
					float3 albedo = c.rgb;
							...
							else
							{
								...
								reflection = DecodeHDREnvironment(skyData, unity_SpecCube0_HDR);
